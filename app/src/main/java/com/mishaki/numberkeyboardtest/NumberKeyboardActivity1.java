...
public class NumberKeyboardActivity1 extends BaseActivity {
    @Override
    ...
    protected void initView() {
        ...
        number_keyboard_inv.setInputViewBackgroundResource(R.drawable.input_view_bg)
                .isDrawDivider(false).isDrawFrame(false)
                .setInputViewMarginLeft((int)(NumberKeyboardUtil.px2dp(this,10f)));
